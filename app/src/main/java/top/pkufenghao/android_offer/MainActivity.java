...
public class MainActivity extends AppCompatActivity implements  View.OnClickListener,ViewPager.OnPageChangeListener {
    ...
    private ImageView img_activity,img_service;
    ...
    private void initViews() {
        ...
        img_activity=(ImageView)findViewById(R.id.activity);
        img_activity.setOnClickListener(this);

        img_service=(ImageView)findViewById(R.id.serv);
        img_service.setOnClickListener(this);
    }

    private void initData() {
        //初始化填充ViewPager的图片资源
        imageResIds = new int[]{R.mipmap.ads1, R.mipmap.ads2, R.mipmap.ads3};
        //图片的描述信息
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            //从集合中获得图片
            int newPosition = position % 3; //数组中总共有5张图片
